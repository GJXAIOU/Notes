...
create table student(
    ...
    age datetime not null comment '出生年月日',
...
create table  course(
    ...
    t_id varchar(10) not null comment '教师编号',
    primary key unique_id(id)
...
```sql
create table score(
    id varchar(10) not null comment '成绩 ID',
    score decimal(18,1) not null comment '成绩分数',
    c_id varchar(10) not null comment '课程 ID'
)engine = 'innodb' charset = 'utf8' comment '成绩表';

insert into score(id,c_id,score) values('01' , '01' , 80);
insert into score(id,c_id,score) values('01' , '02' , 90);
insert into score(id,c_id,score) values('01' , '03' , 99);
insert into score(id,c_id,score) values('02' , '01' , 70);
insert into score(id,c_id,score) values('02' , '02' , 60);
insert into score(id,c_id,score) values('02' , '03' , 80);
insert into score(id,c_id,score) values('03' , '01' , 80);
insert into score(id,c_id,score) values('03' , '02' , 80);
insert into score(id,c_id,score) values('03' , '03' , 80);
insert into score(id,c_id,score) values('04' , '01' , 50);
insert into score(id,c_id,score) values('04' , '02' , 30);
insert into score(id,c_id,score) values('04' , '03' , 20);
insert into score(id,c_id,score) values('05' , '01' , 76);
insert into score(id,c_id,score) values('05' , '02' , 87);
insert into score(id,c_id,score) values('06' , '01' , 31);
insert into score(id,c_id,score) values('06' , '03' , 34);
insert into score(id,c_id,score) values('07' , '02' , 89);
insert into score(id,c_id,score) values('07' , '03' , 98);
```
## 练习题目
