...
然后，我们往表t中插入 10 万行记录，取值按整数递增，即：(1,1,1)，(2,2,2)，(3,3,3) 直到(100000,100000,100000)。
...
图 1 显示的就是使用 explain 命令看到的这条语句的执行情况。

![img](10讲MySQL为什么有时候会选错索引.resource/2cfce769551c6eac9bfbee0563d48fe3.png)
...
![img](10讲MySQL为什么有时候会选错索引.resource/1e5ba1c2934d3b2c0d96b210a27e1a1e.png)
...
![img](10讲MySQL为什么有时候会选错索引.resource/7c58b9c71853b8bba1a8ad5e926de1f6.png)
...
![img](10讲MySQL为什么有时候会选错索引.resource/16dbf8124ad529fec0066950446079d4.png)
...
![img](10讲MySQL为什么有时候会选错索引.resource/1d037f92063e800c3bfff3f4dbf1a2b9.png)
