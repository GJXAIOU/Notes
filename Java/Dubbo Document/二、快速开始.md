...
Dubbo3 推荐使用 IDL 定义跨语言服务，如您更习惯使用特定语言的服务定义方式，请移步[多语言](https://dubbo.apache.org/zh/docs/languages)模块。
...
- [Java IDL Quick Start](https://dubbo.apache.org/zh/docs/languages/java/quick-start)
- [Golang IDL Quick Start](https://dubbo.apache.org/zh/docs/languages/golang/quick-start)
- [Java 语言特定用法](https://dubbo.apache.org/zh/docs/languages/java/java-specific)
- [Golang 语言特定用法](https://dubbo.apache.org/zh/docs/languages/golang/go-specific)