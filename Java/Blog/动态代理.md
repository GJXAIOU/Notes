...
[![bravo1988](https://pic1.zhimg.com/v2-1907eb21be63d35b077e6ed3cbcbfe13_xs.jpg?source=172ae18b)](https://www.zhihu.com/people/huangsunting)
...
专栏最近写了多线程、ThreadLocal、注解相关的文章，这些其实都是我们迈向SSM的小碎步。我们已经离SSM越来越近了，但还不够。今天，我们仍需一起再往前走一小步：动态代理。这四个字一出来，估计很多初学者已经开始冒冷汗。动态代理之所以给人感觉很难，有三点原因：
...
![img](https://pic3.zhimg.com/80/v2-1332d491e2600b21c3ec28454eab3d9e_720w.jpg)静态代理示意图
...
![img](https://pic1.zhimg.com/80/v2-beb7e4fd989ddea7f5eb6fe6fe882c84_720w.jpg)直接返回代理对象，而不是代理对象Class
...
![img](https://pic1.zhimg.com/80/v2-b8adf7e9002d647076bb660c4b499ac4_720w.jpg)注入的是UserServiceImpl类型

- 注入userServiceImpl的代理对象（CGLib动态代理）

![img](https://pic2.zhimg.com/80/v2-dd932daec51739a7ea584e4a2baf6e9d_720w.jpg)注入的是CGLib动态代理生成的userServiceImpl的代理对象
