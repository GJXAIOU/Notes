...
![img](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LrtQOWSnDdXhp3kYN4k%2F-LzvvGoSsStlbJEhgL6E%2F-LzvvJk9VEMjc8iBXq_z%2F1.jpg?generation=1580479649218951&alt=media)

设想一下用锅铲翻转一堆烧饼的情景，其实是有一点限制的，我们每次只能将最上面的若干块饼子翻转：

![img](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LrtQOWSnDdXhp3kYN4k%2F-LzvvGoSsStlbJEhgL6E%2F-LzvvJkBz0VG3sqDKmnd%2F2.png?generation=1580479648392953&alt=media)

我们的问题是，**如何使用算法得到一个翻转序列，使得烧饼堆变得有序**？

首先，需要把这个问题抽象，用数组来表示烧饼堆：

![img](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LrtQOWSnDdXhp3kYN4k%2F-LzvvGoSsStlbJEhgL6E%2F-LzvvJkDNydlyQIRrTHb%2Ftitle.png?generation=1580479648476570&alt=media)

如何解决这个问题呢？其实类似上篇文章 [递归反转链表的一部分](https://labuladong.gitbook.io/algo/shu-ju-jie-gou-xi-lie/di-gui-fan-zhuan-lian-biao-de-yi-bu-fen)，这也是需要**递归思想**的。
...
![img](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LrtQOWSnDdXhp3kYN4k%2F-LzvvGoSsStlbJEhgL6E%2F-LzvvJkFbwcl1v2Xx5eO%2F3.jpg?generation=1580479648502857&alt=media)

那么，原问题的规模就可以减小，递归调用 `pancakeSort(A, n-1)` 即可：

![img](https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/assets%2F-LrtQOWSnDdXhp3kYN4k%2F-LzvvGoSsStlbJEhgL6E%2F-LzvvJkHsXDQ1gqrPxXY%2F4.jpg?generation=1580479648472452&alt=media)
