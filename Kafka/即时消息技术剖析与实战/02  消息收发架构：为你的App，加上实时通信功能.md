...
- 
  ...
  索引表和内容表应该可以合并，这就是一种消息冗余，至于分库的hash的字段，由于没有过这个经验，还真不明白，请老师指点！
...
- 
  ...
  老师，你好，请教两个问题，第一im系统里面的账号关联关系业内一般怎么设计，常用的是哪种？第第二个问题，接收方如何跟服务器保持一个长链接，能否给写个例子看看，如果有上亿的在线用户，那服务器压力岂不是很大，服务器，一台服务器也大约能链接多少在线用户？
