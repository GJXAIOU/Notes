...
- 
  ...
  作者回复: devicetoken 只是识别设备的哈，每台设备的 devicetoken 都不一样。
...
- 
  ...
  作者回复: 一般这些推送服务是已 sdk 的方式集成到你自己的 app 里，推送不是独立存在的一个 app。另外，这个得看下小米的推送服务是否有集成接收方手机的厂商 sdk，如果有，那应该是没问题的，如果没有，估计厂商很难让第三方推送服务的长连接运行。
