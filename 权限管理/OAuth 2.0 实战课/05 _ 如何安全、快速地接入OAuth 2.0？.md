...
在小兔打单软件收到访问令牌的同时，也会收到访问令牌的过期时间 expires\_in。一个设计良好的第三方应用，**应该将expires\_in值保存下来并定时检测**；如果发现 expires\_in 即将过期，则需要利用 refresh\_token 去重新请求授权服务，以便获取新的、有效的访问令牌。
...
![](<https://static001.geekbang.org/resource/image/14/15/140a4efb622e21b21fcc4ff57653a915.png?wh=1598*648> "图2 京麦服务市场“我的服务”")
...
![](<https://static001.geekbang.org/resource/image/e7/f6/e7b134686b9f2e824ffa8410e20f59f6.jpg?wh=1456*630> "图3 3类权限类别")
